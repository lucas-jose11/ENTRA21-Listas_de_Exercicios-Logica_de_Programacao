...
namespace ENTRA21_Listas_de_Exercícios_Lógica_de_Programação.Classes
{
    public class List2
    {
        ...
        static void ExerciseLogicalOperator1()
        {
        ...
        static void ExerciseLogicalOperator2()
        {
        ...
        static void ExerciseLogicalOperator3()
        {
        ...
        static void ExerciseLogicalOperator4()
        {
            ...
            else if (saldoAtual < sacarAgora)           //se eu só colocasse else daria certo?
            {
                Console.WriteLine("Saldo insuficiente.");
            }
        }

        static void ExerciseLogicalOperator5()
        {
        ...
        static void ExerciseSwitchCase1()
        {
            //Exercícios Switch Case
        ...
        static void ExerciseSwitchCase2()
        {
        ...
        static void ExerciseSwitchCase3()
        {
        ...
        static void ExerciseSwitchCase4()
        {
        ...
        static void ExerciseTernaryOperator1()
        {
        ...
        static void ExerciseTernaryOperator2()
        {
        ...
        static void ExerciseTernaryOperator3()
        {
        ...
        static void ExerciseTernaryOperator4()
        {

//Lista 01 - Lógica de Programação - Variáveis
//Primeiro Exercício: Declare uma variável do tipo int, atribua um valor e imprima na tela.
int numero = 10;
Console.Write(numero);


//Segundo Exercício: Crie uma variável string com o nome do seu curso e exiba a mensagem: “Bem - vindo ao curso[nome]”.
string nomeCurso = "C#";
Console.Write($"Bem-vindo ao curso " + nomeCurso);


//Terceiro Exercício: Declare duas variáveis do tipo double, atribua valores e exiba a soma.
double decimalA = 5.3;
double decimalB = 6.7;
Console.WriteLine(decimalA + decimalB);


//Quarto Exercício: Leia um número inteiro do usuário e exiba o quadrado desse número.
